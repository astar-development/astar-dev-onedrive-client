...
public sealed class AppDbContextShould : IDisposable
{
    ...
    public async Task RoundTripDateTimeOffsetCorrectly()
    {
        ...
        DeltaToken token = new("PlaceholderAccountId","test1", "token123", testTime);
    ...
    public async Task RoundTripGuidCorrectly()
    {
        ...
        TransferLog log = new("PlaceholderAccountId", Guid.CreateVersion7().ToString(), TransferType.Download, "item1", DateTimeOffset.UtcNow, null, TransferStatus.Pending, null, null);
    ...
    {
        TransferLog log = new("PlaceholderAccountId","test1", TransferType.Upload, "item1", DateTimeOffset.UtcNow, null, TransferStatus.InProgress, null, null);
    ...
    public async Task RoundTripAllEnumValues()
    {
        ...
        [
            ...
            new TransferLog("PlaceholderAccountId","log4", TransferType.Download, "item4", DateTimeOffset.UtcNow, DateTimeOffset.UtcNow, TransferStatus.Failed, null, "Error")
        ];
    ...
    public async Task RoundTripSyncStateEnumCorrectly()
    {
        ...
        [
            new LocalFileRecord("PlaceholderAccountId", "id1", "file1.txt", null, 100, DateTimeOffset.UtcNow, SyncState.Unknown),
            new LocalFileRecord("PlaceholderAccountId", "id2", "file2.txt", null, 200, DateTimeOffset.UtcNow, SyncState.PendingDownload),
            new LocalFileRecord("PlaceholderAccountId", "id3", "file3.txt", null, 300, DateTimeOffset.UtcNow, SyncState.Downloaded),
            new LocalFileRecord("PlaceholderAccountId", "id4", "file4.txt", null, 400, DateTimeOffset.UtcNow, SyncState.PendingUpload),
            new LocalFileRecord("PlaceholderAccountId", "id5", "file5.txt", null, 500, DateTimeOffset.UtcNow, SyncState.Uploaded),
            new LocalFileRecord("PlaceholderAccountId", "id6", "file6.txt", null, 600, DateTimeOffset.UtcNow, SyncState.Deleted),
            new LocalFileRecord("PlaceholderAccountId", "id7", "file7.txt", null, 700, DateTimeOffset.UtcNow, SyncState.Error)
        ];
    ...
    {
        TransferLog logWithNull = new("PlaceholderAccountId","test1", TransferType.Download, "item1", DateTimeOffset.UtcNow, null, TransferStatus.Pending, null, null);
        TransferLog logWithValue = new("PlaceholderAccountId","test2", TransferType.Upload, "item2", DateTimeOffset.UtcNow, DateTimeOffset.UtcNow.AddHours(1), TransferStatus.Success, null, null);
    ...
    {
        DriveItemRecord itemWithNulls = new("PlaceholderAccountId","id1", "driveId1", "file1.txt", null, null, 100, DateTimeOffset.UtcNow, false, false);
        DriveItemRecord itemWithValues = new("PlaceholderAccountId","id2", "driveId2", "file2.txt", "etag123", "ctag456", 200, DateTimeOffset.UtcNow, false, false);
    ...
    public async Task QueryEntitiesAfterRoundTrip()
    {
        ...
        [
            new DriveItemRecord("PlaceholderAccountId", "id1", "driveId1", "file1.txt", "etag1", null, 100, DateTimeOffset.UtcNow.AddHours(-2), false, false),
            new DriveItemRecord("PlaceholderAccountId", "id2", "driveId2", "folder", null, null, 0, DateTimeOffset.UtcNow.AddHours(-1), true, false),
            new DriveItemRecord("PlaceholderAccountId", "id3", "driveId3", "file2.txt", "etag2", null, 200, DateTimeOffset.UtcNow, false, false)
        ];
