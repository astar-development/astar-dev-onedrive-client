...
public partial class InitialCreation : Migration
{
    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        _ = migrationBuilder.CreateTable(
            ...
            constraints: table => _ = table.PrimaryKey("PK_DeltaTokens", x => x.Id));
        ...
        _ = migrationBuilder.CreateTable(
            ...
            constraints: table => _ = table.PrimaryKey("PK_DriveItems", x => x.Id));
        ...
        _ = migrationBuilder.CreateTable(
            ...
            constraints: table => _ = table.PrimaryKey("PK_LocalFiles", x => x.Id));
        ...
        _ = migrationBuilder.CreateTable(
            ...
            constraints: table => _ = table.PrimaryKey("PK_TransferLogs", x => x.Id));
