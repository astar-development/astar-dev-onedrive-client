...
{
    public static string Generate(IReadOnlyList<OptionsBindingGenerator.OptionsTypeInfo> types)
    {
        ...
        _ = sb.AppendLine("        {");
        foreach(OptionsBindingGenerator.OptionsTypeInfo info in types)
        {
