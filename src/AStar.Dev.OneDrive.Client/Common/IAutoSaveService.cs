...
public interface IAutoSaveService
{
    ...
    /// </summary>
    /// <param name="mainWindowViewModel">The view model to monitor for property changes.</param>
    /// <param name="saveAction">The action to invoke when a monitored property changes.</param>
    void MonitorForChanges(MainWindowViewModel mainWindowViewModel, Action saveAction);

    /// <summary>
    ///     Stops monitoring the view model for property changes and unsubscribes from events.
    /// </summary>
    /// <param name="mainWindowViewModel">The view model to stop monitoring.</param>
    void StopMonitoring(MainWindowViewModel mainWindowViewModel);
}
