...
public interface IThemeSelectionHandler
{
    ...
    /// <param name="userPreferences">The user preferences containing the current theme setting.</param>
    void Initialize(ComboBox themeSelector, UserPreferences userPreferences);
    ...
    /// <param name="userPreferences">The user preferences to update with the new theme selection.</param>
    void UpdatePreferenceOnChange(int selectedIndex, UserPreferences userPreferences);
}
